        ...
        <div id='cards' class='flex gap-5 '>
            <div class='bg-white text-black w-1/4 p-3 border-gray-300 gap-15 border-1  rounded-xl'>
                <header class='flex items-center justify-between p-1 '>
                    <span class='font-medium text-[15px]'>Clientes</span><span class="p-2 rounded-lg bg-[#EBF2FE]">
                ...
                <div class='p-1 text-3xl font-bold'>150</div>
            ...
            <div class='bg-white text-black w-1/4 gap-10 p-3 border-gray-300 border-1 rounded-xl'>
                ...
                <div class='p-1 text-3xl font-bold'>1</div>
                <div class='p-1 text-[14px] text-gray-500'>Total Registrado</div>
            </div>
            {{-- produtos --}}
            <div class='bg-white text-black w-1/4 gap-10 p-3 border-gray-300 border-1 rounded-xl'>
                ...
                <div class='p-1 text-3xl font-bold'>5</div>
                <div class='p-1 text-[14px] text-gray-500'>Total Registrado</div>
            </div>
            {{-- facturas --}}
            <div class='bg-white text-black w-1/4 gap-10 p-3 border-gray-300 border-1 rounded-xl'>
                <header class='flex items-center justify-between p-1 '>
                    <span class='font-medium text-[15px]'>Servicos</span><span class="p-2 rounded-lg bg-[#fef5e6]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
