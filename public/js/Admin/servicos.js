document.addEventListener('DOMContentLoaded', function() {
    ...
    async function carregarServicos() {
        tabela.innerHTML =
            `<tr><td colspan="3" class="text-center text-muted">A carregar serviços...</td></tr>`;
        try {
            ...
            if (!data.length) {
                tabela.innerHTML =
                    `<tr><td colspan="3" class="text-center text-muted">Nenhum serviço encontrado.</td></tr>`;
                return;
            }
            data.forEach(item => {
                tabela.innerHTML += `
                    <tr>
                        ...
                        <td>${parseFloat(item.valor).toLocaleString('pt-AO', { style: 'currency', currency: 'AOA' })}</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="excluirServico(${item.id})">
            ...
            tabela.innerHTML =
                `<tr><td colspan="3" class="text-center text-danger">Erro ao carregar serviços.</td></tr>`;
        }
    }
