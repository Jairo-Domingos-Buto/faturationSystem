  ...
  <style>
    * {
    ...
    .invoice-title h1 {
      ...
      color: #b91c1c;
      /* Vermelho escuro para indicar Crédito/Anulação */
    }
    ...
    /* Annulment Box (Estilo específico para Anulação - Avermelhado) */
    .annulment-box {
      width: 100%;
    ...
    .totals-box {
      background: #fff1f2;
      /* Fundo levemente avermelhado para totais */
...
<body>
  <div class="invoice">
    ...
    <div class="invoice-title">
      ...
      <div class="original">Documento de Anulação Total</div>
    </div>

    <!-- BOX DE ANULAÇÃO (Destaque Vermelho) -->
    <div class="annulment-box clearfix">
      <div style="float:left; width: 60%;">
        <strong>ANULAÇÃO DO DOCUMENTO:</strong> {{ $dados['documento_anulado']['tipo'] }} {{
        $dados['documento_anulado']['numero'] }}
        <br>
        <strong>EMITIDO EM:</strong> {{ $dados['documento_anulado']['data_emissao'] }}
      </div>
    ...
    <!-- TABELA DE PRODUTOS (Itens que foram anulados) -->
    <table class="items-table">
      <thead>
        <tr>
          ...
          <th class="text-right" style="width: 15%;">Pr. Unit.</th>
        ...
        <tr>
          <td class="summary-left">
            ...
            <div class="tax-summary">
              <h3>Resumo de Impostos (Anulados)</h3>
          ...
          {{-- TOTAIS (Crédito Total) --}}
          <td class="summary-right">
            <div class="totals-box">
              <div class="total-line clearfix">
                <span class="label">Total Ilíquido Estornado</span>
                <span class="value">{{ number_format($dados['documento_anulado']['subtotal'], 2, ',', '.') }}</span>
              </div>
              <div class="total-line clearfix">
                <span class="label">Total Impostos Estornado</span>
