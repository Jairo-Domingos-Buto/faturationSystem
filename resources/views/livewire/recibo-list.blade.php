    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 font-medium">Recibos Gerados</p>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <a href="{{ route('admin.fatura.download', $recibo->id) }}"
                                ...
                                <button wire:click="delete({{ $recibo->id }})"
                                    wire:confirm="Tem certeza que deseja eliminar este recibo?"
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <p class="mt-2 text-sm">Nenhum recibo encontrado no período selecionado</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
